...
public class Board {
	...
	public int convertY(Position a) { //МЕТОД ДЛЯ КОНВЕРТАЦИИ
		return a.getX()-'A'+1;
	}
	...
	public void score(Piece p) { //УВЕЛИЧЕНИЕ ОЧКОВ
	...
	public Vector<Position> getRoute(Position a, Position b){ //находятся ли фигуры на одной вертикали, горизонтали или диагонали
	...
	// Проверка на валидность рокировки
	...
	public boolean noObstacles(Position a, Position b) { //    // Проверка на наличие препятствий на пути между двумя позициями
